...
| 8 | Proper nouns | "send this to alex at example dot com via slack" | _(not captured)_ | Send this to Alex@example.com via Slack. | ✅ | Email assembled, "Slack" + "Alex" capitalized. |
