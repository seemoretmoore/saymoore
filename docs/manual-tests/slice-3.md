...
| 8 | Proper nouns | "send this to tracy at clinical pattern dot com via slack" | _(not captured)_ | Send this to Tracy@clinicalpattern.com via Slack. | ✅ | Email assembled, "Slack" + "Tracy" capitalized. |
